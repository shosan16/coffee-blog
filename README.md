...
│   │   ├── route.ts              # GET /api/recipes (検索・一覧)
│   │   └── [id]/route.ts         # GET /api/recipes/{id} (詳細)
│   ├── recipes/[id]/             # レシピ詳細ページ
│   │   ├── page.tsx              # SSRページコンポーネント
...
│
├── server/                       # サーバーサイドコード
│   ├── features/recipes/         # レシピ機能のビジネスロジック
│   │   ├── search/               # 検索機能
