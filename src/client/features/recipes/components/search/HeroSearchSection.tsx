    ...
    <div className="relative overflow-hidden bg-black py-20 text-white">
      ...
      <div className="relative container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          {/* メインタイトル */}
          <Coffee className="mb-6 h-16 w-16 text-white" />
          ...
          <div className="w-full max-w-2xl space-y-4">
            <div onKeyDown={handleKeyDown}>
              <SearchBox
                ...
                className="h-14 border-0 bg-white text-lg text-black shadow-2xl"
            ...
            <div className="hidden sm:block">
              <button
                type="button"
                onClick={applySearch}
                className="rounded-lg bg-white px-8 py-3 font-semibold text-black transition-colors hover:bg-white focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-black focus:outline-none"
              >
                レシピを検索
              </button>
            </div>
